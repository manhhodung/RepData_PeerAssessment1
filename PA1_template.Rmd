...
We can see that Mean of Imputed Data was not changed compare with Mean of steps
that remove NA, however the Median changed to equal Mean.
...
ImpData$date<-format(ImpData$date,"%a")
